...
- **A1_B1_D1_code2_consistency_correalaion.ipynb**  
  Computes correlation of RNA and protein expression patterns across the three samples.

### 3. Interaction Quantification
- **A1_B1_D1_code3_fraction_overlap_calculation.ipynb**  
  Calculates fractional overlap scores for detected protein pairs.
- **A1_B1_D1_code4_fisher_test.ipynb**  
...
### 7. Network Analyses
- **A1_code7_PP_network_analysis.ipynb** – Network analysis for sample A1.  
...
3. **Interaction Quantification**  
   Detects and quantifies significant protein–protein interactions via Fisher’s Exact Test and fractional overlap.
